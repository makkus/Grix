...
//	private CertificateStatusPanel certificateStatusPanel = null;
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			//getCertificateStatusPanel().statusChanged(new CertificateEvent(this,CertificatePanel.READY_ON_CA_SERVER));
...
//	}
	...
	private MessagePanel getMessagePanel() {
		if (messagePanel == null) {
			...
			//uri = this.getClass().getClassLoader().getResource("about.xhtml").getFile();
	...
	private InfoPagePanel getCertificateRequestedPanel() {
		if (certificateRequestedPanel == null) {
				certificateRequestedPanel = new InfoPagePanel("vomrs_register", Color.white);
...
//			try {
//				certificateInfoPanel = new CertificateInfoPanel(new Certificate(new File("/home/markus/.globus/usercert.pem")));
//			} catch (IOException e) {
