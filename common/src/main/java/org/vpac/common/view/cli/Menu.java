...
public class Menu {
	 ...
	 * @param module An array with all the options of the menu
	...
	public static int menu(String[] module){
		...
		try {
			...
			if ( result<0 || result>module.length ) System.out.println("Please provide a number between 0 and "+module.length+".");
			else return result-1;
		} catch (NumberFormatException e) {
			System.out.println("Can't parse your input. Please provide a number.");
		} catch (IOException e) {
