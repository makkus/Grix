...
public class Shlix implements CertificateStatusListener {
	
	public static final String SHLIX_VERSION = "v1.0";

	static final Logger myLogger = Logger.getLogger(Shlix.class.getName());
...
//			jTabbedPane.addTab("LocalProxy", getLocalGridProxyPanel()); // means
																		...
																		// proxy
																		// panel
			jTabbedPane.addTab("Shibboleth login", getSlcsPanel());
...
//			}
	...
	private JFrame getJFrame() {
		if (jFrame == null) {
			...
			jFrame.setTitle("Shlix "+SHLIX_VERSION);
		}
		return jFrame;
	}
...
//			toolsMenu.add(getOptionsMenuItem());
	...
	private JLabel getAboutVersionLabel() {
		if (aboutVersionLabel == null) {
			...
			aboutVersionLabel.setText("Grix "+SHLIX_VERSION);
