 ...
 * argument or arguments that have a constructor that takes one String, e.g. new
 * Integer(String) or new String(string)...
 * 
 * <p>
...
public class Default extends QcRetriever {
	...
	static final Logger myLogger = Logger.getLogger(Default.class.getName());
	...
	public Object[] retrieveValue() throws Exception {
		...
		if (properties.size() == 0)
			...
			String object = ((Element) properties.get(0))
					.getAttributeValue("object");
			String value = ((Element) properties.get(0)).getValue();
			Constructor constructor = Class.forName(object).getConstructor(
			...
			for (int i = 0; i < properties.size(); i++) {
				String object = ((Element) properties.get(i))
						.getAttributeValue("object");
